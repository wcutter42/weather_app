...
export const updateDisplay = (weatherJson, locationObj) => {
    ...
    // current conditions
    const ccArrray = createCurrentConditionsDivs(weatherJson, locationObj.getUnit());
    displayCurrentConditions(ccArrray);
    // six day forecast
...
const buildScreenReaderWeather = (weatherJson, locationObj) => {
    ...
    and ${Math.round(Number(weatherJson.current.temp))}°${tempUnit} in ${location}`;
};
